...
# SET PATHS--------------------------------------------------------------------
# WATER LEVEL directory with all downloaded files
...
# WAVE csv with full storm time series
wave_csv = r"C:\Users\smrosen2\Desktop\Mirlo Beach\Hypothetical Storms\Dylan method\1. Identify storms based on Hs - updated\Hs90storms_greater_than_12hrs.csv"
...
final_merged_df.to_csv("storm_waves_tides_1980_2020_left_merge.csv", index = False)
